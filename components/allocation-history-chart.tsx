    ...
    return (
        <Card className="w-full">
            <CardHeader className="flex flex-row items-center justify-between">
                <CardTitle className="text-xl font-semibold">Allocation History</CardTitle>
            ...
            <CardContent className="p-0 rounded-4 bg-white">
                <ChartContainer config={chartConfig} className="w-full h-[300px] max-w-[1200px]">
                    <ResponsiveContainer width="100%" height="100%">
                        <BarChart data={chartData} margin={{ top: 10, right: 10, left: -10, bottom: 0 }}>
                            ...
                            />
                            <Bar dataKey="value1" stackId="stack" fill="rgb(239, 108, 100)" radius={[0, 0, 4, 4]} />
                            <Bar dataKey="value2" stackId="stack" fill="rgb(146, 136, 224)" radius={[0, 0, 0, 0]} />
                            <Bar dataKey="value3" stackId="stack" fill="rgb(37, 99, 235)" radius={[4, 4, 0, 0]} />
                        </BarChart>
                    </ResponsiveContainer>
                </ChartContainer>
            </CardContent>
