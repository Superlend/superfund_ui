...
interface IWhalesSupportDialogProps {
    ...
    website?: 'AGGREGATOR' | 'MARKETS' | 'SUPERFUND'
}
...
const TelegramButton = ({ logEvent, portfolioValue, walletAddress, onInteraction }: ButtonProps) => {
    const telegramUsername = "superlend_official";
...
const DiscordButton = ({ logEvent, portfolioValue, walletAddress, onInteraction }: ButtonProps) => {
    const discordLink = "https://discord.com/invite/superlend";
    ...
    return (
        <Link
            ...
            className='w-full'
            onClick={() => {
                logEvent('whales_support_discord_clicked', {
                    portfolio_value: portfolioValue,
                    wallet_address: walletAddress
                });
                onInteraction();
                            ...
                            <div className='w-full'>
                                ...
                                <div className="relative flex items-center w-full bg-sky-100 border border-orange-300 rounded-4 p-1 shadow-sm">
                                    ...
                                    <Button
                                        type="submit"
                                        variant="default"
                                        className="absolute right-1.5 top-1/2 -translate-y-1/2 h-[calc(100%-0.75rem)] bg-orange-500 hover:bg-orange-600 disabled:text-orange-300 disabled:cursor-not-allowed text-white rounded-full px-5 py-2 text-sm flex items-center gap-1.5 hover:shadow-md transition-all duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-orange-400 focus:ring-opacity-75"
