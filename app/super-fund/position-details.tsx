                            ...
                            <InfoTooltip
                                label={
                                    <BodyText
                                        ...
                                        className="text-gray-600"
                                    >
                                        <TooltipText>Spot APY</TooltipText>
                                    </BodyText>
                                }
                                content={
                                    <BodyText
                                        ...
                                        className="text-gray-600"
                                    >
                                        The current annualized yield (APY) you
                                        are earning right now, based on
                                        real-time data. This rate can change
                                        frequently basis deposits and
                                        withdrawals.
                                    </BodyText>
                                }
                            />
                            ...
                            <InfoTooltip
                                label={
                                    <BodyText
                                        ...
                                        className="text-gray-600"
                                    >
                                        <TooltipText>Vault APY</TooltipText>
                                    </BodyText>
                                }
                                content={
                                    <BodyText
                                        ...
                                        className="text-gray-600"
                                    >
                                        The overall annual yield (APY) currently
                                        earned by the vault, calculated as a
                                        weighted average of all the strategies
                                        and protocols it&apos;s using.
                                    </BodyText>
                                }
                            />
                            {!isLoadingEffectiveApy &&
                                !isErrorEffectiveApy &&
                                effectiveApyData && (
                                    <motion.div
                                        initial={{ scale: 0.8, opacity: 0 }}
                            ...
                            <InfoTooltip
                                ...
                                content={
                                    <BodyText
                                        ...
                                        className="text-gray-600"
                                    >
                                        The average Vault APY over the past 7
                                        days. This smooths out short-term
                                        changes and shows recent performance
                                        trends.{' '}
                                    </BodyText>
                                }
                            />
                            {!isLoadingHistoricalWeeklyData &&
                                !errorHistoricalWeeklyData && (
                                    <motion.div
                                        initial={{ scale: 0.8, opacity: 0 }}
                                        whileInView={{ scale: 1, opacity: 1 }}
                                        viewport={{ once: true }}
